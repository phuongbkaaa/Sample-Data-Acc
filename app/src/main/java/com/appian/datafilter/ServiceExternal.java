...
public class ServiceExternal extends IntentService {
    ...
    private static final String ACTION_DOWNLOAD_HOSTS_FILE = "com.appian.datafilter.DOWNLOAD_HOSTS_FILE";

    // am startservice -a com.appian.datafilter.DOWNLOAD_HOSTS_FILE
