...
public class ActivityForwardApproval extends Activity {
    private static final String TAG = "Mobile Internet Manager.Forward";
    private static final String ACTION_START_PORT_FORWARD = "com.simpletool.datasaving.START_PORT_FORWARD";
    private static final String ACTION_STOP_PORT_FORWARD = "com.simpletool.datasaving.STOP_PORT_FORWARD";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ACTION_START_PORT_FORWARD.equals(getIntent().getAction())) {
/*
am start -a com.simpletool.datasaving.START_PORT_FORWARD \
-n com.simpletool.datasaving/com.simpletool.datasaving.ActivityForwardApproval \
--ei protocol 17 \
--ei dport 53 \
--es raddr 8.8.4.4 \
--ei rport 53 \
...
/*
am start -a com.simpletool.datasaving.STOP_PORT_FORWARD \
-n com.simpletool.datasaving/com.simpletool.datasaving.ActivityForwardApproval \
--ei protocol 17 \
--ei dport 53 \
--user 0
