...
public class ServiceExternal extends IntentService {
    private static final String TAG = "Mobile Internet Manager.External";
    private static final String ACTION_DOWNLOAD_HOSTS_FILE = "com.simpletool.datasaving.DOWNLOAD_HOSTS_FILE";

    // am startservice -a com.simpletool.datasaving.DOWNLOAD_HOSTS_FILE
